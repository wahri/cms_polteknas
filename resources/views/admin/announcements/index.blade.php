...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">List All Announcements</h3>
            ...
            <table id="tbl-list" data-page-length="25" class="dt-table table table-sm table-bordered table-striped table-hover">
                ...
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td>
                            <a href="/admin/announcements/{{ $item->id }}/crop-resource" class="btn btn-info btn-xs" data-toggle="tooltip" title="Crop {{ $item->name }}">
